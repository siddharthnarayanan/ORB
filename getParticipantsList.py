...
def generateParticipantsList(ProjectsList, participantsList, participantsList1 ):
    ...
    outputfile = open(participantsList, "wb")
    participantsListHeader = "peopleProj_Index	Indiv_Participants	indivPeople_Index"
    outputfile.write(participantsListHeader + "\n")

    anotherfile = open(participantsList1, "wb")
    projectindex=0
